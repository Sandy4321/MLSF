...
% function [predict_target, Outputs] = LLSF_BR(train_data, train_target,test_data,test_target,W_s,svm)
function predict_target = LLSF_BR(train_data, train_target,test_data,test_target,W_s,svm)
...
%         [Pre_Label,~,Output]=svmpredict(test_target(i,:)',temp_testdata,Models{i,1},'-b 1 -q');
       Pre_Label=svmpredict(test_target(i,:)',temp_testdata,Models{i,1},'-q');
