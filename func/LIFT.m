% function [Pre_Labels,Outputs]=LIFT(train_data,train_target,test_data,test_target,ratio,svm)
function Pre_Labels=LIFT(train_data,train_target,test_data,test_target,ratio,svm)
...
%         [predicted_label,accuracy,prob_estimates]=svmpredict(testing_label_vector,testing_instance_matrix,Models{i,1},'-b 1');
        predicted_label=svmpredict(testing_label_vector,testing_instance_matrix,Models{i,1},'-q');
